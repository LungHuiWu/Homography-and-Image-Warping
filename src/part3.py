...
if __name__ == '__main__':
    ...
    corns = np.array([[0, 0],[w, 0],[w, h],[0, h]])
    output3_1 = None
    output3_2 = None
    H1 = solve_homography(corners1, corns)
    H2 = solve_homography(corners2, corns)
    output3_1 = warping(secret1, np.zeros((h,w,c)), H1, 0, h, 0, w, direction='b')
    dst = np.zeros((h, w, c))
    output3_2 = warping(secret2, np.zeros((h,w,c)), H2, 0, h, 0, w, direction='b')
